...
public class WarehouseManager {
	...
	public static void main(String[] args) throws IOException {
		...
		//配列の宣言および初期化処理を記述する
		String[] aisatu = new String[3];
		aisatu[0] = "へい！らっしゃい！！";
		aisatu[1] = "ご用件をお伺い致します。";
		aisatu[2] = "まいどあり！！またどうぞ";
		...
		for (int i = 0; i < aisatu.length; i++) {
			System.out.println("あいさつパターン" + (i + 1) + "..." + aisatu[i]);
		}
		System.out.println("Yさん：");
		...
		String newAisatu = br.readLine();
		aisatu[num - 1] = newAisatu;
